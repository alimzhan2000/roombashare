		...
		if u.mode == 1:
			...
			if distr == 'Алматинский' or distr == 'Байконурский' or distr == 'Есильский' or distr == 'Сарыаркинский':
				...
				if u.seeker.hata == True:
					...
					bot.send_message(message.chat.id, 'Вау, это моq самый любимый район! Сколько ты хочешь брать арендную плату с одного человека?', reply_markup=keyboard)
				else:	
